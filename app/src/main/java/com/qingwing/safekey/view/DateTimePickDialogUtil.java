...
//        String minuteStr = spliteString(time, ":", "index", "back"); // 分
    ...
    private static String spliteString(String srcStr, String pattern, String indexOrLast, String frontOrBack) {
        String result = "";
        int loc = -1;
    ...
    public static String getDateString(Date date, SimpleDateFormat sdf) {
        ...
        try {
            ...
            return sdf.format(getCalendarByInintData(simpleDateFormat.format(date)).getTime());
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
